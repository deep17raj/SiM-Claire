      ...
      */}
      <div className=" w-full max-w-350 mx-auto bg-[#f3f4f6] rounded-2xl p-6 lg:p-8 flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-8 shadow-sm">
        ...
        <div className="flex flex-col sm:flex-row items-center text-center sm:text-left gap-4 w-full md:w-auto">
          ...
          <div className="w-12 h-16 bg-[#f2671c] rounded-xl flex flex-col items-center justify-center shrink-0 relative shadow-sm">
            {/* Checkmark */}
        ...
        <div className="w-full lg:w-auto flex justify-center lg:justify-end shrink-0">
          <button className="px-6 py-2.5 border-2 border-[#2d3240] text-[#2d3240] font-semibold text-[15px] cursor-pointer rounded-lg  hover:text-[#f2671c] hover:border-[#f2671c]  transition-all duration-300 whitespace-nowrap active:scale-95">
            Check Compatibility
          </button>
        </div>
