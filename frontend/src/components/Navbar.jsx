...
const Navbar = () => {
  ...
  return (
    // 🌟 FIX 1: Added relative and z-[100] to the outermost wrapper 
    <div className="px-4 relative z-[100]">
      <nav className="w-full max-w-[1400px] mx-auto bg-secondary shadow-md rounded-full pr-4 pl-6 md:pr-6 py-0 flex items-center justify-between top-4 relative">
        ...
        <button 
          ...
          className="lg:hidden text-tertary hover:text-brand focus:outline-none z-50 p-2 cursor-pointer"
        >
          {isOpen ? (
        ...
        {isOpen && (
          // 🌟 FIX 2: Added z-[100] here as an extra safety measure to guarantee it floats over everything
