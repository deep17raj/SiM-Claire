    ...
    <section className="w-full max-w-350 mx-auto px-4 py-10 md:py-14">
      ...
      <div className="text-center mb-10">
        <h2 className="text-3xl md:text-4xl font-medium text-gray-800 mb-6">
          {/* Changed text-purple-600 to text-[#f2671c] */}
          Travel eSIM for <span className="text-[#f2671c] font-bold">200+</span> countries
        </h2>

        {/* 2. Tabs / Toggles */}
        <div className="flex flex-wrap items-center justify-center gap-3">
          {/* Active Tab */}
          {/* Changed bg-purple-600 to bg-[#f2671c] */}
          <button className="flex items-center gap-2 bg-[#f2671c] text-white px-5 py-2.5 rounded-full text-sm font-medium transition-transform active:scale-95">
          ...
          {/* Inactive Tab */}
          <button className="flex items-center gap-2 bg-gray-100 text-gray-700 hover:bg-gray-200 px-5 py-2.5 rounded-full text-sm font-medium transition-colors">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className=" flex justify-center  items-center mt-8  ">
        <button className="text-centertext-[#000000] border-[#000000] border-2 rounded-lg px-14 py-4 font-bold hover:text-[#f2671c] hover:border-[#f2671c] transition-all duration-300 cursor-pointer">View All Countries</button>
      </div>
