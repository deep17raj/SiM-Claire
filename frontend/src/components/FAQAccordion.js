...
export default function FAQAccordion({ question, answer }) {
    ...
    return (
        <div className="bg-white">
            ...
            >
                <span className={`font-semibold cursor-pointer subheading ${isOpen ? 'text-brand' : 'hcol'} group-hover:text-secondary transition-colors`}>
                    {question}
                </span>
            ...
            >
                <div className="px-6 pb-6 pt-0 desc text-slate-600 leading-relaxed border-l-4 border-brand ml-6 mb-4">
                    {answer}
                </div>
            </div>
        </div>
