...
const ContactForm = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-[#fdfdfd] text-slate-800 relative overflow-hidden font-sans">
      ...
      {/* Bottom Wave SVG */}
      <div className="fixed inset-x-0 bottom-0 pointer-events-none -z-10 text-[#f2671c] opacity-5">
      ...
      <main className="w-full max-w-2xl bg-white shadow-2xl shadow-slate-200/50 rounded-2xl border border-slate-100 overflow-hidden relative">
        <div className="p-8 md:p-12">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center justify-center w-12 h-12 bg-orange-50 rounded-full mb-4 text-[#f2671c]">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="relative z-0 w-full group">
                <input 
                    ...
                    name="fullname" 
                    id="fullname" 
                    className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-slate-200 appearance-none focus:outline-none focus:ring-0 focus:border-[#f2671c] peer" 
                    placeholder=" " 
                    required 
                />
                <label htmlFor="fullname" className="peer-focus:font-medium absolute text-sm text-slate-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-[#f2671c] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                    Full Name*
                </label>
              </div>
            ...
            <div className="relative z-0 w-full group">
                <textarea 
                    ...
                    id="message" 
                    rows="4" 
                    className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-slate-200 appearance-none focus:outline-none focus:ring-0 focus:border-[#f2671c] peer resize-none" 
                    placeholder=" " 
                    required 
                ></textarea>
