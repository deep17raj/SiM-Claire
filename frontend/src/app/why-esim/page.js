      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        <div className="relative w-full min-h-[500px] flex items-center justify-center">
          ...
          <div className="relative z-10 text-center px-4 max-w-xl">
            <h2 className="text-5xl md:text-6xl font-bold leading-tight">
              Why Travelers Trust <span className="text-[#f2671c]">SiM Claire</span>
            </h2>
          </div>

          {/* Bubble 1: Local Rates (Top Left) */}
          <div className="absolute top-0 left-[5%] md:left-[10%] w-40 h-40 md:w-56 md:h-56 rounded-full bg-gradient-to-br from-[#f2671c] to-[#ff9a63] shadow-2xl shadow-[#f2671c]/30 flex flex-col items-center justify-center text-white p-6 text-center hover:scale-105 transition-transform duration-300 -translate-y-12 md:translate-y-0">
          ...
          <div className="absolute bottom-0 left-[2%] md:left-[5%] w-36 h-36 md:w-48 md:h-48 rounded-full bg-white border-2 border-[#f2671c]/20 shadow-xl flex flex-col items-center justify-center text-slate-800 p-4 text-center hover:scale-105 transition-transform duration-300 translate-y-12 md:translate-y-0">
          ...
          <div className="absolute top-[5%] right-[2%] md:right-[5%] w-40 h-40 md:w-52 md:h-52 rounded-full bg-gradient-to-br from-[#f2671c] to-[#ff9a63] shadow-2xl shadow-[#f2671c]/30 flex flex-col items-center justify-center text-white p-6 text-center hover:scale-105 transition-transform duration-300 -translate-y-8 md:translate-y-0">
             <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor" className="mb-2 opacity-90">
               <path d="M21 3L3 21v-2l18-18h-2zm-2 0h2v2l-2-2zM3 3h2L3 5V3zm5 0h2l-2 2V3zM3 7h2l-2 2V7zm5 14v-2h2l-2 2zM3 11h2l-2 2v-2zm13 10v-2h2l-2 2zm-4 0v-2h2l-2 2zm-4 0v-2h2l-2 2z"/>
             </svg>
          ...
          <div className="absolute bottom-[5%] right-[5%] md:right-[10%] w-32 h-32 md:w-44 md:h-44 rounded-full bg-white border-2 border-[#f2671c]/20 shadow-xl flex flex-col items-center justify-center text-slate-800 p-4 text-center hover:scale-105 transition-transform duration-300 translate-y-8 md:translate-y-0">
             <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#f2671c" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mb-2">
        ...
        <div className="mt-16 text-center max-w-3xl mx-auto px-4">
          <p className="text-slate-600 text-lg md:text-xl font-light leading-relaxed">
             ...
             <span className="font-semibold text-[#f2671c]"> SiM Claire </span> 
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
            {/* Primary Action */}
            <Link href="/destination" className="w-full sm:w-auto bg-[#f2671c] hover:bg-[#e05610] text-white px-10 py-4 rounded-full font-semibold text-lg transition-all shadow-lg shadow-[#f2671c]/20 hover:shadow-[#f2671c]/40 active:scale-95 text-center">
               Start Your Journey
            </Link>
