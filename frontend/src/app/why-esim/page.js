  ...
  return (
    <section className="relative py-14 md:py-8 px-4 md:px-12 lg:px-24 overflow-hidden bg-[#fffaf7] text-slate-900">
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        <div className="relative w-full min-h-[480px] lg:min-h-[520px] flex items-center justify-center">
          ...
          <div className="relative z-10 text-center px-4 max-w-xl">
            <h2 className="text-2xl md:text-4xl font-bold leading-tight hcol">
          ...
          <div className="absolute bottom-25 md:bottom-0 left-[2%] md:left-[5%] lg:left-[-4%] w-36 h-36 md:w-48 md:h-48 rounded-full bg-white border-2 border-brand/20 shadow-xl flex flex-col items-center justify-center text-slate-800 p-4 text-center hover:scale-105 transition-transform duration-300 translate-y-12 md:translate-y-0">
        ...
        <div className="mt-0 md:mt-14 text-center max-w-3xl mx-auto px-4 lg:absolute lg:top-70 lg:right-40 ">
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
            {/* Primary Action */}
            <Link href="/esim" className="text-brand text-lg md:text-xl border-brand border-2 rounded-lg px-14 py-4 font-bold hover:bg-brand hover:text-white hover:shadow-lg hover:shadow-orange-500/20 transition-all transform active:scale-95 transition-all duration-300 cursor-pointer">
              Start Your Journey
            </Link>
